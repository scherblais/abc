  ...
  return (
    <div className="flex h-full min-h-full flex-col">
      <header className="safe-top sticky top-0 z-10 -mx-4 flex items-center justify-between border-b border-neutral-200/80 bg-white/85 px-4 py-3 backdrop-blur-md">
        ...
        <h1 className="text-[15px] font-semibold tracking-tightish text-neutral-900">Revenue</h1>
      ...
      <main className="flex-1 pb-12 pt-4">
        {thisMonth && (
          <section className="card mb-5 p-4">
            <p className="text-[12px] font-medium text-neutral-500">{thisMonth.label}</p>
            <div className="mt-1 flex items-baseline gap-2">
              <p className="text-[32px] font-semibold tracking-tightish tabular-nums text-neutral-900">
        ...
        <p className="mb-2 px-0.5 text-[12px] font-medium text-neutral-500">By month</p>

        {months.length === 0 ? (
          <div className="card px-5 py-8 text-center">
            <p className="text-[14px] text-neutral-600">No bookings yet.</p>
          </div>
        ) : (
        ...
        {months.length > 0 && (
          <p className="mt-3 px-0.5 text-[12px] text-neutral-500">
